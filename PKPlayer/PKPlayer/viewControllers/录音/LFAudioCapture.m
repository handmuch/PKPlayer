...
- (instancetype)initWithAudioConfiguration:(LFLiveAudioConfiguration *)configuration{
    if(self = [super init]){
        ...
        AURenderCallbackStruct db;
        db.inputProcRefCon = (__bridge void *)(self);
        db.inputProc = handleOutputBuffer;
        ...
        AudioUnitSetProperty(self.componetInstance, kAudioUnitProperty_SetRenderCallback, kAudioUnitScope_Input, 0, &db, sizeof(db));
...
static OSStatus handleOutputBuffer(void *inRefCon,
                                   AudioUnitRenderActionFlags     *ioActionFlags,
                                   const AudioTimeStamp         *inTimeStamp,
                                   UInt32                         inBusNumber,
                                   UInt32                         inNumberFrames,
    ...
    LFAudioCapture *source = (__bridge LFAudioCapture *)inRefCon;
    OSStatus err = noErr;
//    if (source.audioChainIsBeingReconstructed == NO)
//    {
